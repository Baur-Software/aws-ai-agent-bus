...
export const WORKFLOW_TEMPLATES: WorkflowDefinition[] = [
...

  {
    ...
    name: 'Google Analytics to Trello Pipeline',
    description: 'Automatically fetch top pages from Google Analytics and create Trello cards for content optimization',
    nodes: [
      {
        id: 'trigger-1',
        type: 'trigger',
        ...
        config: {
          ...
          description: 'Start the content analysis workflow'
        }
      },
      {
        id: 'ga-top-pages-1',
      ...
      },
      {
        ...
        outputs: ['output'],
        config: {
          name: 'Content Optimization Review',
          description: 'Review top pages for optimization opportunities',
      ...
      },
      {
        ...
        outputs: ['output'],
        config: {
          detailType: 'ContentAnalysisCompleted',
          detail: {
            status: 'completed',
            timestamp: '{{timestamp}}'
          }
    ...
    connections: [
      { from: 'trigger-1', to: 'ga-top-pages-1', fromOutput: 'output', toInput: 'input' },
      { from: 'ga-top-pages-1', to: 'kv-store-1', fromOutput: 'output', toInput: 'input' },
      { from: 'ga-top-pages-1', to: 'trello-card-1', fromOutput: 'output', toInput: 'input' },
      { from: 'trello-card-1', to: 'events-send-1', fromOutput: 'output', toInput: 'input' }
    ],
    metadata: {
      author: 'AWS AI Agent Bus',
      tags: ['google-analytics', 'trello', 'content', 'automation'],
